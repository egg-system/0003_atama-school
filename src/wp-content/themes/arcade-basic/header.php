...
<head>
	...
	<?php if (is_front_page()) { ?>
		<link rel='stylesheet' href='http://atama-school.com/wp-content/themes/arcade-basic/css/top_add.css' type='text/css' media='all' />
	<?php } ?>
		<link rel='stylesheet' href='http://atama-school.com/wp-content/themes/arcade-basic/css/correction.css' type='text/css' media='all' />
</head>
<?php
                ...
                <div class="title-card">
    				<div id="site-meta">
    					...
    					<<?php echo $tag; ?> id="site-title">
    						<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="http://atama-school.com/wp-content/themes/arcade-basic/images/title_1170.png"></a>
    					</<?php echo $tag; ?>>
