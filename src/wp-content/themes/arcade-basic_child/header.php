...
<head>
	...
	<?php if (is_front_page()) { ?>
		<link rel='stylesheet' href='https://atama-school.com/wp-content/themes/arcade-basic/css/top_add.css' type='text/css' media='all' />
	<?php } ?>
		<link rel='stylesheet' href='https://atama-school.com/wp-content/themes/arcade-basic/css/correction.css' type='text/css' media='all' />
</head>
<?php
                ...
                <div class="title-card">
    				<div id="site-meta">
    					...
    					<<?php echo $tag; ?> id="site-title">
    						<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="http://egg-hp-manage.main.jp/atama-school/wp-content/themes/arcade-basic_child/images/title-new20180517.png"></a>
    					</<?php echo $tag; ?>>
