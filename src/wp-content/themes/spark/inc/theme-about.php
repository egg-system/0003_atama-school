...
<div id="about-page">
	...
	<h1 class="about-title"><i>About</i> <span>SPARK</span></h1>
    ...
    <div class="infohead"><span class="donation">A Theme is an effort of many sleepless nights of the Developers.  If you like this FREEE Theme You can consider for a 5 star rating and honest review. Your review will inspire us. You can <a href="https://wordpress.org/support/view/theme-reviews/spark" target="_blank"><strong>Review Here</strong></a>.</span><br /><br /><br /><span class="donation"> Need More Features and Options including 3D Slides, Unlimited Slide Images, Links from Featured Boxes and 100+ Advanced Features and Controls? Try <a href="<?php echo esc_url('http://d5creation.com/theme/spark/'); ?>" target="_blank"><strong>SPARK Extend</strong></a></span><br /> <br /><br /><span class="donation"> You can Visit the SPARK Extend <a href="<?php echo esc_url('http://demo.d5creation.com/themes/?theme=SPARK'); ?>" target="_blank"><strong>DEMO 1</strong></a> and <a href="<?php echo esc_url('http://demo.d5creation.com/themes/?theme=SPARK-2'); ?>"><strong>DEMO 2</strong></a></span><a href="<?php echo esc_url('http://d5creation.com/theme/spark/'); ?>" target="_blank" class="extendlink"> </a></div>
		...
		<table class="tftable" border="1">
        	<tr><th class="topth">FEATURES</th><th class="topth">SPARK</th><th class="topth">SPARK EXTEND</th></tr>
			<tr><th>You will love These</th><th>Free</th><th>Only $7.5*</th></tr>
			<tr><td>WordPress Latest Version Ready</td><td>YES</td><td>YES</td></tr>
			<tr><td>Sophisticated, Lightweight, and Adaptable</td><td>YES</td><td>YES</td></tr>
			<tr><td>Widgets Ready, Right Sidebar & Footer Sidebar</td><td>YES</td><td>YES</td></tr>
			<tr><td>Excellent and Easy Theme Options</td><td>NO</td><td>YES</td></tr>
			<tr><td>Customizer Options</td><td>YES</td><td>NO</td></tr>
			<tr><td>Slider</td><td>NO</td><td>Unlimited Image</td></tr>
            <tr><td>Exciting 3D Slide, Image, Flash and Video Sliding</td><td>NO</td><td>YES</td></tr>
            <tr><td>VIDEO or EMBED HTML Adding Functionality instead of Sliding Image</td><td>NO</td><td>YES</td></tr>
			...
			<tr><td>Slider Animation</td><td>NO</td><td>04</td></tr>
            <tr><td>Featured Boxes with 02 Layout, with or without the Row Title and Description</td><td>Limited</td><td>Unlimited</td></tr>
            <tr><td>Featured Boxes with Links</td><td>NO</td><td>YES</td></tr>
            <tr><td>Videos, Iframe, HTML etc. Showing Facilities within the 06 Featured Boxes</td><td>NO</td><td>YES</td></tr>
			<tr><td>RESPONSIVE</td><td>YES</td><td>YES</td></tr>
			<tr><td>Logo and Favicon Inserter Option</td><td>NO</td><td>YES</td></tr>
            <tr><td>Staffs' Box</td><td>NO</td><td>YES</td></tr>
            <tr><td>Contact Box</td><td>NO</td><td>YES</td></tr>
            <tr><td>Social Media Integration Options</td><td>Only 05</td><td>20 and Any including Facebook, Twitter etc.</td></tr>
            ...
            <tr><td>PSD Files Included</td><td>NO</td><td>YES</td></tr>
            <tr><td>E-Commerce Ready by WooCommerce!</td><td>NO</td><td>YES</td></tr>
            <tr><td>Three Site Layout. Full Width, Left Sidebar or Right Sidebar Option</td><td>NO</td><td>YES</td></tr>
            <tr><td>Easy Color Changing Options</td><td>NO</td><td>YES</td></tr>
            <tr><td>Font Size, Font Face, Font Color Customization Options for Page/Post Title, Body, Heading etc...</td><td>NO</td><td>YES</td></tr>
            <tr><td>Featured Images and Posts can be shown in Slider</td><td>NO</td><td>YES</td></tr>
            <tr><td>Post Meta for Selecting which Post should be used for Sliding</td><td>NO</td><td>YES</td></tr>
            ...
            <tr><td>Unlimited Client or Partner List with or without Links Adding Function</td><td>NO</td><td>YES</td></tr>
